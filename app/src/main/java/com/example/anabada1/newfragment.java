...
public class newfragment extends Fragment {
    ...
    private void navigateTogoods1() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods1.class);
        startActivity(intent);
    ...
    private void navigateTogoods2() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods2.class);
        startActivity(intent);
    ...
    private void navigateTogoods3() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods3.class);
        startActivity(intent);
    ...
    private void navigateTogoods4() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods4.class);
        startActivity(intent);
    ...
    private void navigateTogoods5() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods5.class);
        startActivity(intent);
    ...
    private void navigateTogoods6() {
        // 카테고리 화면으로 이동하기 위해 Intent를 사용합니다.
        Intent intent = new Intent(getActivity(), newgoods6.class);
        startActivity(intent);
